   ...
   <form action="game/addGame.action" method="post" enctype="multipart/form-data">
    <div class="panel-body" style="text-align: center;">
    	<div class="form-group" style="text-align: left;">
    		<strong>游戏名称：</strong>
    		<input id="gameName" type="text" placeholder="请输入游戏名称" name="gameName" class="input" style="width:150px; line-height:17px;display:inline-block;margin-top:5px;" />
    	...
    	<div class="form-group" style="text-align: left;">
    		<strong>游戏详情：</strong>
    		<textarea id="gameDetail" placeholder="请输入游戏详情" name="gameDetail" class="input" style="width:280px; line-height:17px;display:inline-block;margin-top:5px;resize:none;" ></textarea><br/>
    	</div>
    	<div class="form-group" style="text-align: left;">
    		<strong>游戏图片：</strong>
    	...
    	<div class="form-group" style="text-align: left;">
    		<strong>话费价格：</strong>
    		<input id="gameFee" type="text" placeholder="请输入" name="gameFee" class="input" style="width:70px; line-height:17px;display:inline-block;margin-top:5px;" />
    		&nbsp;&nbsp;&nbsp;&nbsp;
    		<strong>乐豆价格：</strong>
    		<input id="gameBeans" type="text" placeholder="请输入" name="gameBeans" class="input" style="width:70px; line-height:17px;display:inline-block;margin-top:5px;" /><br/>
    	</div>
